...
1. [こちらをクリックしてダウンロード](https://github.com/op5no29/Salis-Screensaver/releases/latest/download/Salis.saver.zip) (Ctrl+クリックで新しいタブで開きます)
...
1. [Click here to Download](https://github.com/op5no29/Salis-Screensaver/releases/latest/download/Salis.saver.zip) (Ctrl+click to open in a new tab)
